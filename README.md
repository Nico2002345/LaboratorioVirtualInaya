...
./.venv/Scripts/python manage.py loaddata grados
...
- ✅ Frontend: login, registro con selección de grado, pantallas de inicio por rol (placeholders para módulos/laboratorios).
- ⏳ Pendiente: `content` (módulos y contenidos), `labs` (laboratorios interactivos), `assignments`/`submissions` (actividades, entregas, calificaciones).
