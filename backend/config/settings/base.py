...
# Base de datos: si no hay DATABASE_URL, usa SQLite local (desarrollo sin Docker/Postgres).
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "Laboratorio Virtual <no-reply@labvirtual.local>")

# URL del frontend, usada para construir el enlace de restablecimiento de contraseña.
